...
def chunk_text_by_paragraphs(text: str, chunk_size: int = 256, overlap: int = 32) -> List[str]:
    """
    Hybrid approach: 
...
def chunk_text_by_headings(
    ...
    # Note: parts[0] may be text before the first heading.
...
def store_embeddings_locally(
    ...
    output_folder: str = "embeddings_by_heading_haystack2230"
):
    """
...
def main():
    ...
    # Store them locally
    store_embeddings_locally(doc_embeddings, chunk_embeddings, chunk_texts, output_folder="embeddings_by_heading_haystack2230")
